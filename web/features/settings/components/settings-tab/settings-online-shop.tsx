    ...
    return (
        <s-section>
            <s-stack gap="base">
                ...
                <s-checkbox
                    label="Automatically inject widgets into HTML"
                    details="Uncheck to stop showing bundle widgets on places where you didn't manually put in the bundler target elements."
                />
                <s-checkbox

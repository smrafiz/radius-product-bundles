...
export const COLOR_THEMES = [
    { label: 'Brand', value: 'brand' as const, background: 'bg-fill-brand' as const },
    { label: 'Success', value: 'success' as const, background: 'bg-fill-success' as const },
    { label: 'Warning', value: 'warning' as const, background: 'bg-fill-warning' as const },
    { label: 'Critical', value: 'critical' as const, background: 'bg-fill-critical' as const },
];
...
export const ADVANCED_OPTIONS = [
    ...
    },
    {
        ...
        description: "Allow customers to quickly swap products within the bundle",
    },
];
...
export const VALIDATION_MESSAGES = {
    ...
    MAX_DISCOUNT_NOT_APPLICABLE: "Maximum discount amount is not applicable for custom price",

...
export type CollectionFilterFieldsFragment = Pick<
...
export type CollectionDetailsFieldsFragment = Pick<
    AdminTypes.Collection,
    "id" | "title" | "handle" | "description" | "updatedAt"
> & {
    image?: AdminTypes.Maybe<
        Pick<AdminTypes.Image, "id" | "url" | "altText" | "width" | "height">
    >;
};
...
export type PageInfoFieldsFragment = Pick<
    AdminTypes.PageInfo,
...
export type ProductFieldsFragment = Pick<
    ...
    | "updatedAt"
> & {
    featuredImage?: AdminTypes.Maybe<
        Pick<AdminTypes.Image, "id" | "url" | "altText" | "width" | "height">
    >;
    variants: {
        nodes: Array<
            ...
            > & {
                selectedOptions: Array<
                    Pick<AdminTypes.SelectedOption, "name" | "value">
                >;
                image?: AdminTypes.Maybe<
                    Pick<
                        AdminTypes.Image,
...
export type ProductCardFieldsFragment = Pick<
    AdminTypes.Product,
...
export type GetCollectionsForFiltersQuery = {
    collections: {
        edges: Array<
    ...
    products: {
        edges: Array<{
            node: Pick<AdminTypes.Product, "productType" | "status">;
        }>;
    };
};
...
export type GetCollectionByHandleQuery = {
    collectionByHandle?: AdminTypes.Maybe<
        Pick<
            AdminTypes.Collection,
            "id" | "title" | "handle" | "description" | "updatedAt"
        > & {
...
export type GetProductsByIdsQueryVariables = AdminTypes.Exact<{
    ids:
        | Array<AdminTypes.Scalars["ID"]["input"]>
        | AdminTypes.Scalars["ID"]["input"];
}>;
...
export type GetBundleProductsQueryVariables = AdminTypes.Exact<{
    ids:
        | Array<AdminTypes.Scalars["ID"]["input"]>
        | AdminTypes.Scalars["ID"]["input"];
}>;

export type GetBundleProductsQuery = {
    nodes: Array<
        AdminTypes.Maybe<
            Pick<AdminTypes.Product, "id" | "title" | "handle"> & {
                featuredImage?: AdminTypes.Maybe<
                    Pick<AdminTypes.Image, "url" | "altText">
                >;
                variants: {
                    nodes: Array<
                        Pick<
...
export type GetShopInfoQueryVariables = AdminTypes.Exact<{
    [key: string]: never;
}>;
...
export type GetShopInfoQuery = {
    shop: Pick<
        AdminTypes.Shop,
        "currencyCode" | "myshopifyDomain" | "email" | "name"
    > & {
        plan: Pick<AdminTypes.ShopPlan, "displayName">;
        billingAddress: Pick<AdminTypes.ShopAddress, "countryCode">;
    };
};
...
interface GeneratedQueryTypes {
    "query GetCollectionsForFilters($query: String, $first: Int!, $after: String) {\n  collections(first: $first, after: $after, query: $query, sortKey: TITLE) {\n    edges {\n      node {\n        ...CollectionFilterFields\n      }\n      cursor\n    }\n    pageInfo {\n      ...PageInfoFields\n    }\n  }\n  products(first: 100) {\n    edges {\n      node {\n        productType\n        status\n      }\n    }\n  }\n}\n\nquery GetCollections($first: Int!, $after: String, $query: String) {\n  collections(first: $first, after: $after, query: $query) {\n    edges {\n      node {\n        ...CollectionFields\n      }\n      cursor\n    }\n    pageInfo {\n      ...PageInfoFields\n    }\n  }\n}\n\nquery GetCollectionByHandle($handle: String!) {\n  collectionByHandle(handle: $handle) {\n    ...CollectionDetailsFields\n    products(first: 50) {\n      edges {\n        node {\n          ...ProductCardFields\n        }\n        cursor\n      }\n      pageInfo {\n        ...PageInfoFields\n      }\n    }\n  }\n}": {
        return: never;
        variables: GetCollectionsForFiltersQueryVariables &
    ...
    "query GetShopInfo {\n  shop {\n    currencyCode\n    myshopifyDomain\n    email\n    name\n    plan {\n      displayName\n    }\n    billingAddress {\n      countryCode\n    }\n  }\n}": {
        ...
        variables: GetShopInfoQueryVariables;
    };
}

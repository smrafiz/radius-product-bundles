...
export type GetBundleProductsQuery = { nodes: Array<AdminTypes.Maybe<(
    Pick<AdminTypes.Product, 'id' | 'title' | 'handle'>
    & { featuredImage?: AdminTypes.Maybe<Pick<AdminTypes.Image, 'url' | 'altText'>>, variants: { nodes: Array<Pick<AdminTypes.ProductVariant, 'id' | 'title' | 'price' | 'compareAtPrice'>> } }
  )>> };
...
interface GeneratedQueryTypes {
  ...
  "query GetProducts($first: Int!, $after: String, $query: String, $sortKey: ProductSortKeys, $reverse: Boolean) {\n  products(\n    first: $first\n    after: $after\n    query: $query\n    sortKey: $sortKey\n    reverse: $reverse\n  ) {\n    edges {\n      node {\n        ...ProductFields\n        allCollections: collections(first: 100) {\n          edges {\n            node {\n              id\n              title\n              handle\n            }\n          }\n        }\n      }\n      cursor\n    }\n    pageInfo {\n      ...PageInfoFields\n    }\n  }\n}\n\nquery GetProductById($id: ID!) {\n  product(id: $id) {\n    id\n    title\n    handle\n    vendor\n    productType\n    tags\n    totalInventory\n  }\n}\n\nquery GetProductsByIds($ids: [ID!]!) {\n  nodes(ids: $ids) {\n    ... on Product {\n      ...ProductFields\n    }\n  }\n}\n\nquery GetBundleProducts($ids: [ID!]!) {\n  nodes(ids: $ids) {\n    ... on Product {\n      id\n      title\n      handle\n      featuredImage {\n        url\n        altText\n      }\n      variants(first: 50) {\n        nodes {\n          id\n          title\n          price\n          compareAtPrice\n        }\n      }\n    }\n  }\n}": {return: never, variables: GetProductsQueryVariables & GetProductByIdQueryVariables & GetProductsByIdsQueryVariables & GetBundleProductsQueryVariables},

...
export async function middleware(request: NextRequest) {
    ...
    if (sessionCookie || shopCookie) {
        return addSecurityHeaders(NextResponse.next(), searchParams.get("shop") || shopCookie?.value);
    }
...
function addSecurityHeaders(response: NextResponse, shop: string | null): NextResponse {

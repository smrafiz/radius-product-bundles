...
**`web/lib/shopify/webhooks/gdpr.ts:45-48`** — Contains only comments explaining what _should_ be done. No actual data extraction or delivery. Shopify requires you to compile and deliver customer data within 30 days.

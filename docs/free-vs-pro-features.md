...
| Feature                                                                   |       Free       |         Pro         |
| ------------------------------------------------------------------------- | :--------------: | :-----------------: |
| Widget on product pages                                                   |       Yes        |         Yes         |
...
| Feature                                      |    Free     |       Pro        |
| -------------------------------------------- | :---------: | :--------------: |
| Setup guide (5-step onboarding)              |     Yes     |       Yes        |
...
| Feature                       | Free | Pro |
| ----------------------------- | :--: | :-: |
| Default discount type & value | Yes  | Yes |
| Redirect after add-to-cart    | Yes  | Yes |
| Enable/disable analytics      | Yes  | Yes |
...
### 7. Shopify Extensions

| Feature                                    | Free | Pro |
| ------------------------------------------ | :--: | :-: |
| Storefront widget (Liquid theme extension) | Yes  | Yes |
| Discount function (Rust WASM)              | Yes  | Yes |
| Line-item discount calculation             | Yes  | Yes |
| Delivery/shipping discount                 |  —   | Yes |
| App proxy (products API)                   | Yes  | Yes |
...
| Feature                      |     Free     |   Pro    |
| ---------------------------- | :----------: | :------: |
| Bundle scheduling via cron   |      —       |   Yes    |
| Webhook idempotency          |     Yes      |   Yes    |
| Cold-start webhook recovery  |     Yes      |   Yes    |
| Rate limiting (proxy routes) |     Yes      |   Yes    |
| Image uploads                | 1 per bundle | Multiple |
| Support page & FAQ           |     Yes      |   Yes    |
...
```
Shop.plan → "FREE" | "PRO" (default: "FREE")
```

No new tables needed. The existing `Shop.plan` field handles this.
...
| --------------------- | ------------ | -------- | ---------- |
| Free installs/month   | 100          | 200      | 400        |
| Free → Pro conversion | 5%           | 8%       | 12%        |
| Pro subscribers/month | 5            | 16       | 48         |
| Monthly revenue       | $49.95       | $159.84  | $479.52    |
| 12-month cumulative   | ~$3,300      | ~$11,500 | ~$34,500   |

_Based on typical Shopify app conversion rates of 5–15% for well-priced apps._

_Note: Higher free-tier generosity typically improves conversion rates — merchants who see real results (BOGO working, CVR visible) are more likely to upgrade for the polish features._

---

_Document revised: March 18, 2026_
_Based on competitive analysis of 5+ Shopify bundle apps and market standards_

Sources:

- [Bundler Pricing](https://bundler.app/pricing)
- [Fast Bundle - Shopify App Store](https://apps.shopify.com/fast-bundle-product-bundles)
- [PickyStory/Amplify - Shopify App Store](https://apps.shopify.com/product-kits-bundles-pickystory)
- [Best Bundle Apps Comparison](https://www.omnisend.com/blog/shopify-bundles/)
- [Shopify App Store - Product Bundles](https://apps.shopify.com/categories/marketing-and-conversion-upsell-and-bundles-product-bundles/all)
